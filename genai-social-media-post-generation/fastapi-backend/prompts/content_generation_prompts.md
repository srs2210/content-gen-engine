...
2. **Disclaimer Requirement:** Determine if the post contains any of the following:
    ...
    * Event Invitations
    ...
    If the post includes *any* of these elements *and is not related to recruitment*, a disclaimer link **must** be included. The required disclaimer link is: `www.google.com`
